...
const tabs = [
  { id: "general", label: "General", icon: Info, href: "/project" },
  { id: "api-keys", label: "API Keys", icon: Key, href: "/project/api-keys" },
  { id: "usage", label: "Usage", icon: BarChart3, href: "/project/usage" },
  { id: "settings", label: "Settings", icon: Settings, href: "/project/settings" },
] as const
...
export function ProjectTabsHeader() {
  ...
  const activeTab = tabs.find((tab) => {
    if (tab.href === "/project") return pathname === "/project"
